## Деплой приложения petsshare на удаленный сервер
petsshare - приложение для обмена фотографиями своих питомцев.
...
## Установка проекта на локальный компьютер из репозитория 
 ...
 - в директории /backend/petsshare_backend/ создать файл .env
...
- В директории _/etc/systemd/system/_ создайте файл _gunicorn.service_ `sudo nano /etc/systemd/system/gunicorn.service`  со следующим кодом (без комментариев):
	    ...
	    ExecStart=/home/<имя пользователя в системе>/<имя проекта>/venv/bin/gunicorn --bind 0.0.0.0:8080 petsshare_backend.wsgi
